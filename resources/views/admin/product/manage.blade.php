              ...
              <table id="datatable1" class="table display responsive nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{!empty($row->category) ?$row->category->category_name:'' }}</td>
                    ...
                    <td>
                        ...
                        <a href="{{ url('admin/products/delete/'.$row->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure To Delet')"><i class="fa fa-trash"></i></a>
  
                        @if($row->status == 1)
  
                        <a href="{{ url('admin/products/inactive/'.$row->id) }}" class="btn btn-sm btn-danger"><i class="fa fa-arrow-down"></i></a>
                        @else
                        <a href="{{ url('admin/products/active/'.$row->id) }}" class="btn btn-sm btn-success"><i class="fa fa-arrow-up"></a>
                        @endif
                      </td>
                  </tr>
                  @endforeach
